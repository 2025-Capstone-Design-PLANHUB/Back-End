...
public class TestSecurityContext implements WithSecurityContextFactory<TestMemberId> {

    @Override
    public SecurityContext createSecurityContext(TestMemberId annotation) {
